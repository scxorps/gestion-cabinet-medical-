...
public class DashboardNurse extends JFrame {
    ...
    public DashboardNurse(String name, String role, int page) {
        ...
        this.Acceuil.addActionListener(e -> {
            ...
            this.Rendez_vous.setBackground(new Color(0x07337a));
            this.Patient.setBorder(null);
            this.Rendez_vous.setBorder(null);
            this.Acceuil.setBorder(new MatteBorder(0, 2, 2, 0, Color.red));
        });
        ...
        this.Rendez_vous = new JButton("Salle D'attentes");
        this.Rendez_vous.setBounds(0, 320, 200, 60);
        this.Rendez_vous.setForeground(Color.white);
        this.Rendez_vous.setBackground(new Color(0x07337a));
        this.Rendez_vous.setFocusable(false);
        this.Rendez_vous.setBorder(null);
        this.Rendez_vous.setFont(new Font("Arial", Font.BOLD, 16));

        this.Rendez_vous.addActionListener(e -> {
           
            tabbedPane.setSelectedIndex(2);
            this.Patient.setBackground(new Color(0x07337a));
            this.Acceuil.setBackground(new Color(0x07337a));
            this.Rendez_vous.setBackground(new Color(0X011b45));
            this.Patient.setBorder(null);
            this.Acceuil.setBorder(null);
            this.Rendez_vous.setBorder(new MatteBorder(0, 2, 2, 0, Color.red));
        });
