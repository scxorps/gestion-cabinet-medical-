...
public class AddConspage extends JFrame {
    ...
    public AddConspage(String id1,String name, String surname,String nom,String prenom,String age,String sexe,String ntel,String adresse) {
        ...
        JTextArea ancField = new JTextArea(); 
        ...
        JTextField ordField1 = new JTextField();
        ...
        savButton.addActionListener(e ->{
            ...
            if (isAncEmpty || isConsEmpty || isOrdEmpty || isPriceEmpty){
               ...
               if(db.InsertCons(idPatient, anc, cons, ord, price)){
                JOptionPane.showMessageDialog(null, "Consultation enregistré", "Succes", JOptionPane.PLAIN_MESSAGE,
